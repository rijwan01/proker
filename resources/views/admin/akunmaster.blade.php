        ...
        <div class="modal-dialog modal-dialog-centered" style="width:55%;">
            <div class="modal-content" style="overflow: hidden;">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-success updateRegistrasi">Update
                    </button>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
   var config = {
    ...
    $('body').on('click', '.updateData', function () {
        ...
        firebase.database().ref('registrasi/' + updateID).on('value', function (snapshot) {
            ...
            var updateData = '<div class="form-group">\
                ...
                <div class="col-md-12">\
                    <input id="Name" type="hidden" class="form-control" value="' + values.Nama + '" required autofocus>\
                </div>\
            </div>\
            ...
            <div class="form-group">\
                <label for="Keterangan" class="col-md-12 col-form-label">Keterangan</label>\
                <div class="col-md-12">\
    ...
    $('.updateRegistrasi').on('click', function () {
