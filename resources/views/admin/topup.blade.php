        ...
        <div class="modal-dialog modal-dialog-centered" style="width:55%;">
            <div class="modal-content" style="overflow: hidden;">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-success acceptTopup">Accept
                    </button>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
   var config = {
    ...
    // Get Data
    firebase.database().ref('top_up/').on('value', function (snapshot) {
    ...
    $('body').on('click', '.acceptData', function () {
        ...
        firebase.database().ref('registrasi/' + acceptID).on('value', function (snapshot) {
            ...
            <div class="form-group">\
                <label for="Tlp" class="col-md-12 col-form-label">Tlp</label>\
                <div class="col-md-12">\
            ...
            <div class="form-group">\
                <label for="nomer_member" class="col-md-12 col-form-label">Nomer Member</label>\
                <div class="col-md-12">\
            ...
            <div class="form-group">\
                <label for="last_name" class="col-md-12 col-form-label">Keterangan</label>\
                <div class="col-md-12">\
                    <input id="Keterangan" type="text" class="form-control" name="Keterangan" value="' + values.Keterangan + '" required autofocus>\
                </div>\
            </div>';
    ...
    $('.acceptTopup').on('click', function () {
        ...
        var accepts = {};
        accepts['/top_up/' + acceptID] = postData;
